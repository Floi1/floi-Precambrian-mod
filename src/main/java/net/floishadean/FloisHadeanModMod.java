...
@Mod("flois_hadean_mod")
public class FloisHadeanModMod {
	public static final Logger LOGGER = LogManager.getLogger(FloisHadeanModMod.class);
	public static final String MODID = "flois_hadean_mod";

	public FloisHadeanModMod(IEventBus modEventBus) {
